  ...
  <div class="home">
     <div class=" container">
        ...
        <div class="row justify-content-start">
          <card-inven v-for="inventory in inventories" :key="inventory.id" :inventory="inventory" />
            <div class="col-4">
...
<script>
// @ is an alias to /src
import CardInven from '../components/CardInven.vue'
export default {
  name: 'Home',
  components: {
    CardInven
  ...
  created () {
    ...
    this.$store.dispatch('actFetchInventories')
  }
}
</script>
